...
describe('OutsDisplay', () => {
  it('renders 3 circles', () => {
    const { container } = render(
      <OutsDisplay outs={0} outsRemaining={3} totalOutsRemaining={null} currentPitcher={null} />
    );
  ...
  it('shows totalOutsRemaining when provided', () => {
    render(
      <OutsDisplay outs={1} outsRemaining={2} totalOutsRemaining={14} currentPitcher={null} />
    );
  ...
  it('shows singular label when totalOutsRemaining is 1', () => {
    render(<OutsDisplay outs={2} outsRemaining={1} totalOutsRemaining={1} currentPitcher={null} />);
